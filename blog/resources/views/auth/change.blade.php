    ...
    <form method="post" onsubmit="return changePass()">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="password_o" value="{{old('password_o')}}"> </i>请输入原始密码</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="password_confirmation", value="{{old('password_confirmation')}}"> </i>再次输入密码</span>
                </td>
            </tr>
            <tr>
                <th></th>
