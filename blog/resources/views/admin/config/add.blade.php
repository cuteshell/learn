            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>必须填写配置标题</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>必须填写配置名称</span>
                    </td>
                </tr>
                <tr>
                    <th>排序：</th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="type" value="input" checked>input <span> </span>
                        <input type="radio" name="type" value="textarea">textarea <span> </span>
                        <input type="radio" name="type" value="radio">radio <span> </span>
                        <span><i class="fa fa-exclamation-circle yellow"></i>必须填写配置类型</span>
                    </td>
                </tr>
                <tr>
                    <th>描述：</th>
