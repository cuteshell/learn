...
<div class="result_wrap">
    ...
    <form action="{{url('admin/config/'.old('id'))}}" method="post">
        {{method_field('put')}}
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="type" value="input"
                            @if(old('type') == 'input' || old('type') == '')
                            checked
                            @endif >input <span> </span>
                        <input type="radio" name="type" value="textarea"
                            @if(old('type') == 'textarea')
                            checked
                            @endif >textarea <span> </span>
                        <input type="radio" name="type" value="radio"
                            @if(old('type') == 'radio')
                            checked
                            @endif >radio <span> </span>
